...
% Calculate fundamental matrix between each image and the reference
th = 2.0;
...
idx_car_I1 = 1197;
idx_car_I2 = sm12(2,sm12(1,:)==idx_car_I1);% ToDo: identify the corresponding point of idx_car_I1 in image 2
idx_car_I3 = sm13(2,sm13(1,:)==idx_car_I1);% ToDo: identify the corresponding point of idx_car_I1 in image 3
idx_car_I4 = sm14(2,sm14(1,:)==idx_car_I1);% ToDo: identify the corresponding point of idx_car_I1 in image 4
