...
% hold on;
% t=1:0.1:1000;
% plot(t+x_min, -(lr1(1)*t + lr1(3)) / lr1(2) + y_min, 'y');
% plot(t+x_min, -(lr2(1)*t + lr2(3)) / lr2(2) + y_min, 'y');
% plot(t+x_min, -(lr3(1)*t + lr3(3)) / lr3(2) + y_min, 'y');
% plot(t+x_min, -(lr4(1)*t + lr4(3)) / lr4(2) + y_min, 'y');
% 
